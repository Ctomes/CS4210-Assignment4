...
# SPECIFICATION: This program will build a Neural Network using the Sequential API, from the fashion_mnist dataset. Various hyper params will be tested to determine the most accurate model.
...
for nh in n_hidden:                        #looking or the best parameters w.r.t the number of hidden layers
    for nn in n_neurons:                   #looking or the best parameters w.r.t the number of neurons
